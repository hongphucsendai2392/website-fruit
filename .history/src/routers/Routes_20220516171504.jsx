  ...
  return (
    <Routes>
      ...
      <Route path="/catalog" element={<Catalog />}>
        ...
        <Route path="/catalog/gift/:id" element={<Product />}></Route>
        <Route path="/catalog/gift" element={<Gift />}></Route>
        <Route path="/catalog/food/:id" element={<Product />}></Route>
        <Route path="/catalog/food" element={<Food />}></Route>
        <Route path="/catalog/confectionery/:id" element={<Product />}></Route>
        <Route
