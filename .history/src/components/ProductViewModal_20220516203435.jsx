...
const ProductViewModal = () => {
  ...
  return (
    <>
      ...
      <div
        className={`product__view__modal ${gift === undefined ? "" : "active"}`}
      >
        <div className="product__view__modal__content">
          <ProductView product={gift} />
          <div className="product__view__modal__content__close">
            <Button size="sm" onClick={() => dispatch(remove())}>
              Đóng
            </Button>
      ...
      <div
        className={`product__view__modal ${food === undefined ? "" : "active"}`}
      >
        <div className="product__view__modal__content">
          <ProductView product={food} />
          <div className="product__view__modal__content__close">
            <Button size="sm" onClick={() => dispatch(remove())}>
              Đóng
            </Button>
      ...
      <div
        className={`product__view__modal ${
          confectionery === undefined ? "" : "active"
        }`}
      >
        <div className="product__view__modal__content">
