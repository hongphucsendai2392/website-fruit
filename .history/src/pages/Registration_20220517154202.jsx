...
const Registration = () => {
  ...
  const [filterName, setFilterName] = useState(idUsers);
  ...
  const handleClickForm = (event) => {
    ...
    console.log(filterName.filter((e) => e.name.includes(user.name)));
    if (user.name) {
      if (filterName.filter((e) => e.name.includes(user.name)) === null) {
        dispatch(setId(user));
        navigate("/");
      }
