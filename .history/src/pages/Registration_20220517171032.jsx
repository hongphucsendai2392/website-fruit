...
const Registration = () => {
  ...
  const [username, setUsername] = useState(idUsers.find((e) => e.name === user.name);)
  const handleClickForm = (event) => {
    console.log(idUsers.find((e) => e.name === user.name));
    const userName = idUsers.find((e) => e.name === user.name);
    ...
    if (user.name) {
      if (userName === undefined) {
        ...
        console.log("ten da ton tai");
        setErrName("Tên đã tồn tại");
      }
    } else {
        ...
        <div className="container__logregi">
          ...
          <div className="container__logregi__user">
            <div className="container__logregi__user__name">
              ...
              ></input>
              <p>{user.name !== "" ? "" : errName || username === undefined ? "" : errName}</p>
            </div>
